...
<body>
    ...
    async sendBookingConfirmation(email: string, name: string, bookingDetails: BookingDetails): Promise<{ success: boolean; error?: string }> {
        const html = `
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="email-wrapper">
        <div class="email-container">
            ...
            <div class="email-header">
                ...
                <p style="color: #666666; font-size: 14px;">Get ready for an amazing experience</p>
            </div>
            ...
            <div class="email-content">
                ...
                <p style="color: #4a5568; margin-bottom: 20px; font-size: 14px; line-height: 1.5;">
                    Your movie booking has been successfully confirmed! We're excited to have you join us for this cinematic experience.
                </p>
                
                <!-- Booking Summary -->
                <div class="booking-summary">
                    <h3 style="margin-bottom: 20px; color: #1a1a1a; font-size: 16px; font-weight: 600;">Booking Details</h3>
                    <div class="summary-grid">
                        <div class="summary-item">
                            <span class="summary-label">Movie</span>
                            <span class="summary-value">${bookingDetails.movieTitle}</span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-label">Date & Time</span>
                            <span class="summary-value">${bookingDetails.showtime}</span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-label">Theater</span>
                            <span class="summary-value">${bookingDetails.theater}</span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-label">Screen</span>
                            <span class="summary-value">${bookingDetails.screen}</span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-label">Seats</span>
                            <span class="summary-value">${bookingDetails.seats.join(', ')}</span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-label">Total Amount</span>
                            <span class="summary-value">$${bookingDetails.totalAmount}</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="email-footer">
                <p class="footer-text">&copy; ${new Date().getFullYear()} BookMyCinema. All rights reserved.</p>
                <p class="footer-text" style="color: #999999;">Thank you for choosing BookMyCinema!</p>
            </div>
        </div>
    </div>
</body>
